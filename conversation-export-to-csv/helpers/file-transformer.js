        ...
        .then(() => {
            lineReader.eachLine(TMP_RAW_FILE_PATH, (line, last, cb) => {
                ...
                let csvFileLine = {
                    ...
                    42: conversationItem.content.type == 'TOPIC_CHANGE' ? conversationItem.content.addedTopicIds.join(',') : '',
                    43: conversationItem.content.type == 'TOPIC_CHANGE' ? conversationItem.content.removedTopicIds.join(',') : '',
